...
Uso:
    python tools/voice_gen.py [NombreDeVoz]

Requisitos previos:
    1. ELEVENLABS_API_KEY en .env
    2. pip install -r 00_Orchestrator/tools/requirements.txt

Lee workspace/script/script_for_elevenlabs.txt y genera WAVs en workspace/assets/audio/.
...
from core.config import get_credential  # noqa
