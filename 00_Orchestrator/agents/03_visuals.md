...
- **Herramienta sugerida:** QGIS / Python (geopandas) / Flourish
...
4. Lista de assets a producir (mapas, gráficos, imágenes)
5. Lista de datos a descargar para mapas
6. Herramientas de producción sugeridas
